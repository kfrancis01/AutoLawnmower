...
long offset = 750; //total offset from beacon positions
...
bool TurningVar = 0;
int encoderSpeed = 50; // encoder ticks per second
...
double TicksPerDegree = 3.13*8.26/8; // Ratio of Ticks to the degrees turned (was 1.56)
